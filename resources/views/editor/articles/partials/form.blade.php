...
<div class="mb-4">
    ...
    {!! Form::text('slug', null, ['class'=>'form-input block w-full mt-1'.($errors->has('title') ? ' border-red-600' : '')]) !!}
</div>
<div class="mb-4">
...
<div class="grid grid-cols-3 gap-4">
    <div class="col-span-1">
        {!! Form::label('article_id', 'Sección :') !!}
        {!! Form::select('article_id', $categories, null, ['class'=>'form-input block w-full mt-1']) !!}
    </div>
</div>
...
<div class="grid grid-cols-2 gap-4">
    ...
    <div>
        ...
        <p class="mb-4">Seleccione la imagen destacada del artículo que decea publicar</p>
